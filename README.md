...
I don't just write code. I find fundamental gaps in ecosystems, document the research, and build open-source tools that change how developers work.
...
Since 2019, I've been a Tech Lead, architecting and building high-load systems. This is the environment that gave birth to the tools above.

- **Leadership**: Leading a 6-person backend team since 2023.
- **Systems**: High-load marketplaces, event-driven architectures, observability stacks.
- **Culture**: Introduced adversarial review, ADR processes, and semantic release workflows.

**Stack**: Go, PostgreSQL, Redis, Kafka, Docker. (Everything you'd expect).
